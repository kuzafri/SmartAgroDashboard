...
def on_message(client, userdata, msg):
    try:
        ...
        processed_data = {
            ...
            'rain_value': int(payload.get('rain_value', 0)),  # Added rain value
        ...
        print("\nSensor Readings:")
        print(f"Soil Moisture: {processed_data['soil_moisture']}")
        print(f"Rain Value: {processed_data['rain_value']}")
        print(f"Is Raining: {processed_data['is_raining']}")
        print(f"Soil Pump Status: {processed_data['soil_pump']}")
        print(f"Timestamp: {processed_data['arduino_timestamp']}")
        print(f"UTC Time: {processed_data['BSON UTC']}")
